...
#wrapper1 = LabelFrame(root, text= 'Comandos')
#wrapper1.pack(fill='both', expand='yes',padx=3, pady=3)

_lbl_job = Label(wrapper0, text="Pick_id")
...
#column_names = select_command("SELECT column_name FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'onhand_ingredients'")
#columns = table_column_names('onhand_ingredients')
#print(columns)
#acolumns = [columns[i][0] for i in range (0,len(columns))]
#print(acolumns)

"""
onhand_ingredients columns

"('index',)
[('unnamed: 0',), ('part number',), ('description_x',), ('qty',), ('unnamed: 3',), ('location',), ('tracking',),
 ('available',), ('data_available',), ('data_available_flag',), ('part',), ('description_y',), ('uom',), ('onhand',),
 ('allocated',), ('notavailable',), ('dropship',), ('onorder',), ('committed',), ('short',), ('commited_flag',)]
"""
...
"""
command_text = "select part_index, part_number, part_name, part_unit from parts"
df = postgresql_to_dataframe(conn,command_text, ['part_number','location','expiration','qty'])
#print(df)
