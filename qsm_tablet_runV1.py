...
V3.2 using ttkwidget.autocomplete import AutocompleteCombobox Stable
...
wrapper0 = LabelFrame(root, text="", font=font_wrap_title)
...
title_label = Label(wrapper0, text="TABLE RUN SHEET", font=font_main_title)
title_label.pack()
...
part_number_lbl = Label(wrapper2, text="Visual Inspection", font=font_label)
...
part_name_lbl = Label(wrapper2, text="Thickness(mm)", font=font_label)
...
part_lot_lbl = Label(wrapper2, text="Hardness(N)", font=font_label)
...
qty_lbl = Label(wrapper2, text="Barrel #", font=font_label)
...
unit_lbl = Label(wrapper2, text="Fill Weight (mg)", font=font_label)
...
checked_by_lbl = Label(wrapper2, text="Checked by", font=font_label)
checked_by_lbl.grid(row=6, column=0, padx=PADX, pady=PADY)
checked_by_ent = Entry(wrapper2, textvariable=part_unit_sel, font=font_entry)
checked_by_ent.grid(row=6, column=1, padx=PADX, pady=PADY, sticky=W)
checked_by_ent.insert(0,"ea")


list_verified_by_tablet = ["ADRIANA","ALVARO","ANGEL RODAS","ANTONIO","BENITO","BRENDA","CERAFIN","CHAPO","CONCHA","DANIEL","DENIS"
    ,"FELIX","FELIPE","JAIME","JAVIER","JORGE","MARIA","MANUEL","OMAR","SILVERIO","SILVIA","RUBEN","RAFAEL",
                    "STAGE ROOM","VILMAR","WILL"]

verified_by_tablet_lbl = Label(wrapper2, text="Verified by (TABLET)", font=font_label)
verified_by_tablet_lbl.grid(row=7, column=0, padx=PADX, pady=PADY)
verified_by_tablet_ent = AutocompleteCombobox(wrapper2, completevalues=list_verified_by_tablet, textvariable=received_by_sel
                                       )

verified_by_tablet_ent.grid(row=7, column=1, padx=PADX, pady=PADY, ipadx=100, sticky=W)



list_verified_by_qc = ["ANA LONGORIA","VICTORIA OSUNA","GERMAIN LONGSALE"]

delivered_by_lbl = Label(wrapper2, text="Verified by (QC)", font=font_label)
delivered_by_lbl.grid(row=8, column=0, padx=PADX, pady=PADY)
delivered_by_ent = AutocompleteCombobox(wrapper2, completevalues=list_verified_by_qc, textvariable=delivered_by_sel, font=font_entry)
...
add_btn = Button(wrapper2, text="OK",  font=font_button, width=10)
add_btn.grid(row=10, column=0, padx=5, pady=3, sticky=EW)

clear_btn = Button(wrapper2, text="Clear",  font=font_button, width=10)
