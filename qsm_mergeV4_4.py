...
elements_qsm = merge_inner[['part_number','description_x', 'unit', 'lot', 'expiration', 'available_x']]

try:
    file_name = folder+'elemens_qsm_'+actual_date()+'.csv'
    elements_qsm.to_csv(file_name)
