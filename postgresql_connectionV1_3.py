...
#command_text = "select part_number, location, tracking, qty from onhand_ingredients"
#df = postgresql_to_dataframe(conn,command_text, ['part_number','location','tracking','qty'])
print(df)
